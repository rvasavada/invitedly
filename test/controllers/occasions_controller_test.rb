...
class OccasionsControllerTest < ActionController::TestCase
  ...
  test "should create occasion" do
    assert_difference('Occasion.count') do
      post :create, occasion: { description: @occasion.description, name: @occasion.name, slug: @occasion.slug, user_id: @occasion.user_id }
    end
  ...
  test "should update occasion" do
    patch :update, id: @occasion, occasion: { description: @occasion.description, name: @occasion.name, slug: @occasion.slug, user_id: @occasion.user_id }
    assert_redirected_to occasion_path(assigns(:occasion))
  end
